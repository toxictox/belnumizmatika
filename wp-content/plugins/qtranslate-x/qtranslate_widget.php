...
function qtranxf_generateLanguageSelectCode($args = array(), $id='') {
	...
	echo PHP_EOL.'<div class="lang-choice">'.PHP_EOL;
	switch($type) {
		case 'image':
		case 'text':
		case 'css_only':
		case 'dropdown': {
			foreach(qtranxf_getSortedLanguages() as $language) {
				...
				echo '<a href="'.qtranxf_convertURL($url, $language, false, true).'" class="lang-choice-russian" style="background: url('.$flag_location.$q_config['flag'][$language].');"';
				// set hreflang
	...
	echo '</div><div class="qtranxs_widget_end"></div>'.PHP_EOL;
}
