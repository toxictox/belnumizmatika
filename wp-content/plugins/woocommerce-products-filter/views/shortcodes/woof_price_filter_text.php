...
<div class="options-text">
    ...
    <input type="text" class="woof_price_filter_txt woof_price_filter_txt_from" placeholder="<?php _e('Цена от', 'woocommerce-products-filter'); ?>" data-value="<?php echo $min_price_data ?>" value="<?php echo $min_price ?>" />&nbsp;<input type="text" class="woof_price_filter_txt woof_price_filter_txt_to" placeholder="<?php _e('Цена до', 'woocommerce-products-filter'); ?>" name="max_price" data-value="<?php echo $max_price_data ?>" value="<?php echo $max_price ?>" />
